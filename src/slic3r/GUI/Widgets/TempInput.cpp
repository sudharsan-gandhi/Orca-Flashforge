...
ShowTip::ShowTip(const wxString& info) : TitleDialog(static_cast<wxWindow*>(Slic3r::GUI::wxGetApp().GetMainTopWindow()), _L("Tip"), 6)
{
    m_sizer_main = MainSizer();
...
void ShowTip::SetLabel(const wxString& info) { m_info->SetLabel(info); }
...
{
    text_ctrl->Bind(wxEVT_CHAR, [&](wxKeyEvent& event) { event.Skip(false); });
}
...
IconText::IconText(
    wxWindow* parent, wxString icon, int iconSize, wxString text, int textSize, const wxPoint& pos, const wxSize& size, long style)
...
IconBottonText::IconBottonText(wxWindow*      parent,
                               wxString       icon,
                               int            iconSize,
                               wxString       text,
                               int            textSize,
    ...
    wxWindow* parent, wxString icon, int iconSize, wxString text, int textSize, wxString secondIcon, wxString thirdIcon, bool positiveOrder)
{
    ...
    if (secondIcon.IsEmpty()) {
        m_dec_btn = new FFPushButton(m_panel_page, wxID_ANY, "push_button_dec_normal", "push_button_dec_hover", "push_button_dec_press",
                                     "push_button_dec_disable", 20);
    } else {
    ...
    if (secondIcon.IsEmpty()) {
        m_inc_btn = new FFPushButton(m_panel_page, wxID_ANY, "push_button_inc_normal", "push_button_inc_hover", "push_button_inc_press",
                                     "push_button_inc_disable", 20);
    } else {
...
void IconBottonText::setAdjustValue(double value) { m_adjust_value = value; }

wxString IconBottonText::getTextValue() { return m_text_ctrl->GetValue(); }
...
void IconBottonText::setCurValue(double value) { m_cur_value = value; }

void IconBottonText::setPoint(int value) { m_point = value; }
...
StartFiltering::StartFiltering(wxWindow* parent) : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL)
{
    SetBackgroundColour(*wxWHITE);
    create_panel(this);
}
...
void StartFiltering::create_panel(wxWindow* parent)
{
    ...
    auto m_staticText_internal_circulate = new wxStaticText(internal_circulate_panel, wxID_ANY, _L("Internal Circulate"), wxDefaultPosition,
    ...
    auto m_staticText_external_circulate = new wxStaticText(external_circulate_panel, wxID_ANY, _L("External Circulate"), wxDefaultPosition,
                                                            wxDefaultSize, wxALIGN_CENTER);
...
TempMixDevice::TempMixDevice(wxWindow*      parent,
                             bool           idle,
                             wxString       nozzleTemp,
...
void TempMixDevice::create_panel(wxWindow* parent, bool idle, wxString nozzleTemp, wxString platformTemp, wxString cavityTemp)
{
    ...
    auto m_panel_temperature_separotor0 = new wxPanel(m_panel_temperature, wxID_ANY, wxDefaultPosition, wxSize(FromDIP(6), -1),
                                                      wxTAB_TRAVERSAL);
    ...
    auto m_panel_temperature_separotor1 = new wxPanel(m_panel_temperature, wxID_ANY, wxDefaultPosition, wxSize(FromDIP(6), -1),
                                                      wxTAB_TRAVERSAL);
...
void TempMixDevice::setDeviceInfoBtnIcon(const wxString& icon) { m_idle_device_info_button->SetIcon(icon); }

void TempMixDevice::modifyTemp(wxString nozzleTemp, wxString platformTemp, wxString cavityTemp, int topTemp, int bottomTemp, int chamberTemp)
{
...
void TempMixDevice::modifyDeviceInfo(
    wxString machineType, wxString sprayNozzle, wxString printSize, wxString version, wxString number, wxString material)
{
