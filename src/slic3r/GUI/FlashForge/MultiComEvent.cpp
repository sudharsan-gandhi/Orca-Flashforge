...
wxDEFINE_EVENT(COM_ADD_PRINT_LIST_MODEL_EVENT, ComBusRequestEvent);
wxDEFINE_EVENT(COM_REMOVE_PRINT_LIST_MODEL_EVENT, ComBusRequestEvent);
wxDEFINE_EVENT(COM_REPORT_MODEL_EVENT, ComBusRequestEvent);
