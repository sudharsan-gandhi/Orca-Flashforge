...
void PromoShareDlg::drawBackground(wxBufferedPaintDC &dc, wxGraphicsContext *gc)
{
    ...
    int message3Y = message2Y + m_message2Size.y + m_message2Space + controlsSpace;
    dc.SetFont(Label::Body_12);
    dc.SetTextForeground("#999999");
    dc.DrawText(m_message3, messageX, message3Y);
}
...
void PromoShareDlg::initSize()
{
    ...
    int totalHeight = copyBtnTop + copyBtnHeight + m_buttonSpace + m_message3Size.y + m_message3Space;
