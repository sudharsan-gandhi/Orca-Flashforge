    ...
    : TitleDialog(static_cast<wxWindow*>(wxGetApp().GetMainTopWindow()), _L("ConnectPrinter(LAN)"), 6)
{
    ...
    m_button_confirm = new FFPushButton(this, wxID_ANY, "access_code_confirm_normal", "access_code_confirm_hover",
                                        "access_code_confirm_press", "access_code_confirm_normal", 30);
...
void ConnectPrinterDialog::on_show(wxShowEvent& event) { Layout(); }
