...
ConfigSubstitutions ConfigBase::load_from_gcode_file(const std::string &file, ForwardCompatibilitySubstitutionRule compatibility_rule)
{
    ...
    bool has_delimiters = true;
    {
        ...
        std::string orcaslicer_gcode_header = std::string("; generated by OrcaSlicer");

        std::string orca_flashforge_gcode_header = std::string("; generated by Orca-Flashforge");

        std::string flash_studio_gcode_header = std::string("; generated by Flash Studio");
        ...
        while (std::getline(ifs, header)) {
            ...
            if (strncmp(bambuslicer_gcode_header.c_str(), line_c, strlen(bambuslicer_gcode_header.c_str())) == 0 ||
                ...
                strncmp(flash_studio_gcode_header.c_str(), line_c, strlen(flash_studio_gcode_header.c_str())) == 0) {
                header_found = true;
                break;
            }
        }
